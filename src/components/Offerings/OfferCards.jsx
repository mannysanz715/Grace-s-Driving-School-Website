...
function OfferCards({title, buttonText, buttonText2, buttonLink2, image, buttonLink}){
  ...
  return(
    <div data-aos='flip-left' className="bg-sky-400 w-3/6 h-[18rem] max-sm:flex-col-reverse gap-5 max-sm:h-fit max-sm:text-center max-sm:w-72 flex justify-evenly items-center p-5 opacity-90">
