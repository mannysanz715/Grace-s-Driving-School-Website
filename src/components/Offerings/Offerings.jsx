...
export default function Offerings(){
  return(
    <div className="bg-sky-400 w-screen">
    <div className="flex flex-col pt-10 bg-yellow-300 max-sm:pb-32 gap-20 max-sm:gap-5 max-sm:pt-14">
      ...
      <div className="h-[32rem] flex flex-col gap-10 justify-evenly items-center bg-yellow-300 max-sm:flex-col max-sm:pt-16 max-sm:h-screen">
        ...
        <OfferCards title="Traffic School" buttonText="Log In" buttonText2="Sign Up" image="/assets/kid.png" buttonLink="https://traffic.gracesdrivingschooled.com/signup/index.html?secure=1&" buttonLink2="https://traffic.gracesdrivingschooled.com/course/login.html?secure=1" buttonType="link"/>
      </div>
    </div>
