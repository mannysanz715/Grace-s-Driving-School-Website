...
function Payments(){
  ...
  return(
    <>
      <h1 className="font-bold text-lg justify-center items-center pt-10">All Payments Through Stripe Have a ~ 3.5% Transaction Fee (Payments through Zelle/Venmo/Cash are not subject to this fee)</h1>
